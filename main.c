 ...
 * Si un jugador tiene exactamente 21 puntos, se dice "BLACKJACK" y gana automáticamente a la casa.
 * Después de que el jugador termine de pedir sus cartas, recién entonces la casa empieza a pedir.
